...
public class CellsTest{
	...
	*/
	...
	public final void testSetCellAsVisitedToZero() {
		...
		assertTrue(cells.hasMaskedBitsFalse(0, 0, Cells.CW_VISITED));
		//cells.setBitToOne(0, 0, Constants.CW_VISITED);
		cells.initialize(); // sets all visited flags to 1
		assertTrue(cells.hasMaskedBitsTrue(0, 0, Cells.CW_VISITED));
	...
	public final void testInitialize() {
		cells.initialize();
		assertTrue(cells.hasMaskedBitsTrue(0, 0, cells.getBoundForBit(Cells.CW_TOP))); 
		assertTrue(cells.hasMaskedBitsTrue(0, 0, cells.getBoundForBit(Cells.CW_LEFT)));
		assertFalse(cells.hasMaskedBitsTrue(0, 0, cells.getBoundForBit(Cells.CW_BOT)));
		assertFalse(cells.hasMaskedBitsTrue(0, 0, cells.getBoundForBit(Cells.CW_RIGHT)));
		//assertTrue(cells.hasMaskedBitsTrue(0, 0, Cells.CW_ALL_BOUNDS));
		assertTrue(cells.hasMaskedBitsTrue(0, 0, Cells.CW_ALL));
		assertTrue(cells.hasMaskedBitsTrue(0, 0, Cells.CW_VISITED));
	...
	public final void testAddAndDeleteWall() {
		...
		cells.initialize();
		assertTrue(cells.hasMaskedBitsTrue(0,0,Cells.CW_RIGHT));
		assertTrue(cells.hasMaskedBitsTrue(1,0,Cells.CW_LEFT));
		...
		assertTrue(cells.hasMaskedBitsFalse(0,0,Cells.CW_RIGHT));
		assertTrue(cells.hasMaskedBitsFalse(1,0,Cells.CW_LEFT));
	...
	public final void testMarkAreaAsRoom() {
		...
		Wall wall = new Wall(5, 5, CardinalDirection.getDirection(0, 1)) ;
	...
	public final void testHasMaskedBitsTrue() {
		...
		cells.setCellAsVisited(0, 0);
		assertFalse(cells.hasMaskedBitsTrue(0, 0, Cells.CW_VISITED));
	}
	...
	public void testGetCWConstantForDirection() {
		Cells cell1 = new Cells(1, 1);
		assertEquals(cell1.getCWConstantForDirection(CardinalDirection.East),Cells.CW_RIGHT);
		assertEquals(cell1.getCWConstantForDirection(CardinalDirection.West),Cells.CW_LEFT);
		assertEquals(cell1.getCWConstantForDirection(CardinalDirection.South),Cells.CW_BOT);
		assertEquals(cell1.getCWConstantForDirection(CardinalDirection.North),Cells.CW_TOP);
	}
